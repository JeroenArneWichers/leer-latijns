    ...
    <div class="row spacer200top">
        <div class="col-lg-12 content order-lg-1 order-1">
            ...
            <form id="quiz" name="quiz"> 
                ...
                {{-- <p id="question2" class="font-weight-bold">Vertaal naar het nederlands: "Agricolae estis."</p>
                <input type="radio" id="multiplechoice" name="question2" value="De boeren zijn"> De boeren zijn<br>
                <input type="radio" id="multiplechoice" name="question2" value="De boer is"> De boer is<br>
